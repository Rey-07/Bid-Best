            ...
            <section id="services" className="services">
              <div className="container">
                <div className="section-title" data-aos="fade-up">
                  <h2>Services</h2>
                  <p>
                    The purpose of the system is to make an Online auction
                    system with proper security
                  </p>
                </div>
                ...
                <div className="row">
                  <div className="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                    ...
                    >
                      ...
                      <p className="description">
                        ...
                        will be available only for the decided time by seller
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                    ...
                    >
                      ...
                      <p className="description">
                        ...
                        instantly. As seller make any update, the database will
                        be updated
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                    ...
                    >
                      ...
                      <p className="description">
                        A user-friendly website. Through help/contact section
                        user can get any help if needed.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                    ...
                    >
                      ...
                      <p className="description">
                        Encryption of password will be there. All the details of
                        the product is true and valid. The proofs of product
                        must be there. All the valid identities of seller and
                        bidder will be there.
                      </p>
                    </div>
                  </div>
                </div>
