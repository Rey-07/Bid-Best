                    ...
                    <div className="row">
                      ...
                      >
                        <div className="feature-1 text-center">
                          ...
                          <p>
                            All the sellers are to be verified through our
                            system. Your account details are secures. User's
                            password is to be encrypted .You can bid safely
                            without any 3rd party interruption.
                          </p>
                        </div>
                      </div>
                      <div
                      ...
                      >
                        <div className="feature-1 text-center">
                          ...
                          <p>
                            The web-app can available 24*7. User can login and
                            register at website at any time. Lots of the product
                            will be available only for the decided time by
                            seller.
                          </p>
                        </div>
                      </div>
                      ...
                      >
                        <div className="feature-1 text-center">
                          ...
                          <p>
                            The seller can update/add/delete the product data
                            instantly. Easy steps to sell your product via
                            bidding.User can easily update their profile.{" "}
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="container">
                    <div className="row align-items-center crtlot">
                      ...
                      >
                        ...
                        <p className="mb-4">
                          All the valid information related to item for bidding
                          i.e. lot name, description of the item, category of
                          item, date of bidding, minimum price, end time of
                          bidding, payment method, images of product
                        </p>
                        <p>
                  ...
                  <div className="container">
                    <div className="row align-items-center">
                      ...
                      >
                        ...
                        <p className="mb-4">
                          Customer will see the product detail and if interested
                          in product then he/she will make a bid of that
                          product, valid identity proof
                        </p>
                        <p>
                          <a href="#" className="btn btn-primary">
                            Get Started
